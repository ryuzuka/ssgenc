...
<body>
  <div class="wrap">
        ...
        <div class="inner">
          <div class="sub-header">
            ...
            <div class="btn-box">
              ...
              @if ($biz_area!=='05')
                <a href="#" id="result_list" class="btn btn-primary result"><span>실적보기</span></a>
              @endif

              @if ($biz_area==='02')
                <a href="https://villiv.co.kr/main" target="_blank" title="새창 열림" class="btn btn-tertiary">
                  <span>VILLIV 바로가기</span>
                </a>
              @endif
            ...
            <div class="content" role="tabpanel">
                ...
                <div class="pj-cont">
                          ...
                          <a href="{{ url('main-project-detail?id='.$main_item->id) }}">
                            <div class="inner-cell">
                              <picture>
                                ...
                                {{-- PC용 메인이미지 --}}
                                <img src="{{ $main_item->main_image }}" alt="{{ $main_item->name_ko }}">

                              </picture>
                            </div>
                            <div class="inner-cell">
                              <em class="sg-text-03">{{ $main_item->name_ko }}</em>
                              ...
                              <span class="sg-text-10">
                                ...
                                @else
                                  {{ date('Y-m', strtotime($main_item->from)) }} ~ 
                                    @if($main_item->project_yn == 'Y') {{ '진행중' }} @else {{ date('Y-m', strtotime($main_item->to)) }} @endif
                                @endif

                              </span>

                              <p class="sg-text-08">{!! $main_item->desc_ko !!}</p>
                            </div>
                          </a>
                        </div>
                  ...
                  @if ( isset($items) )
                    ...
                    <div class="btn-wrap">
                      <button type="button" class="btn btn-secondary more"><span>더보기</span></button>
                    </div>
    ...
    {{-- 프로젝트 실적 팝업 --}}
    @include('main.ko.project.pj_result', [
      'biz_area' => $biz_area,
