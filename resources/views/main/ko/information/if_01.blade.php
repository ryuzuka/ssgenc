        ...
        <div class="group-box">
          <div class="inner">
            ...
            <ul class="list01 video-list">
              <li data-pop="video-pop7">
                <a href="#">
                  <picture>
                    <source media="(max-width: 1024px)" srcset="/images/information/img-if1-07.jpg">
                    <img src="/images/information/img-if1-07.jpg" alt="">
                  </picture>
                  <div class="desc">
              ...
              <li data-pop="video-pop8">
                <a href="#">
                  <picture>
                    <source media="(max-width: 1024px)" srcset="/images/information/img-if1-08.jpg">
                    <img src="/images/information/img-if1-08.jpg" alt="">
                  </picture>
                  <div class="desc">
              ...
              <li data-pop="video-pop9">
                <a href="#">
                  <picture>
                    <source media="(max-width: 1024px)" srcset="/images/information/img-if1-09.jpg">
                    <img src="/images/information/img-if1-09.jpg" alt="">
                  </picture>
                  <div class="desc">
              ...
              <li data-pop="video-pop10" style="display: none">
                <a href="#">
                  <picture>
                    <source media="(max-width: 1024px)" srcset="/images/information/img-if1-10.jpg">
                    <img src="/images/information/img-if1-10.jpg" alt="">
                  </picture>
                  <div class="desc">
