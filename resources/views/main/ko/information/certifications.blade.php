          ...
          <div class="tab">
            <div class="dropdown tabs js-dropdown" placeholder="수상">
              ...
              <ul class="dropdown-list" role="listbox" aria-labelledby="dropdown" tabindex="-1">
                ...
                <li role="option" aria-selected="true"><button type="button" data-value="">인증</button></li>
              </ul>
            </div>
            <div class="tab-list" role="tablist">
              <button type="button" id="tab1" role="tab" aria-controls="tab-content1" aria-selected="false">수상</button>
              <button type="button" id="tab2" role="tab" aria-controls="tab-content2" aria-selected="true">인증</button>
            </div>
