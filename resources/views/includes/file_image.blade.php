...
<td>
    <div class="file-box">
        <input type="text" id="{{ $id_name }}_file_nm" name="{{ $id_name }}_file_nm" class="attach-text w375" readonly placeholder="파일첨부">
    ...
    <div class="regist-text">
        <div class="area">
            ...
            <input id="{{ $id_name }}_text" type="text" class="w375" value="{{ (isset($file_text))? $file_text:''}}">
        </div> 
    </div>
</td>
