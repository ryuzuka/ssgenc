{{-- 
  // 페이지명 : 로그인 이력 관리 목록
  // 설명 : 로그인 이력 관리 목록을 페이지 단위로 표시 한다.
--}}
...
@section('column_title')
  ...
  <tr>
    ...
    <th scope="col">오류메시지</th>
    <th scope="col">로그인상태</th>
...
<script>
  ...
  $(function(){
    ...
    function Search(page)
    {
      ...
      $(location).attr('href', "{{ url('/logins-list?') }}"+jQuery.param(params) );
    }
    ...
    function download()
    {
      ...
      $.ajax({
        url: "{{ url('/api/logins/log-download') }}",
        type: "GET",
        data: params,
