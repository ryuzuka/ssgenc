      ...
      <table cellpadding="0" cellspacing="0" style="width:100%;font-family:'Malgun Gothic', Dotum,'돋움',Helvetica,'Apple SD Gothic Neo',sans-serif">
        ...
        <tr>
          <td style="font-size:16px;color:#000;line-height:27px;">
            @if ($type=='01')
              @if($lang=='ko') 문의하신 내용에 대한 답변이 완료되었습니다. @else Your inquiry has been answered. @endif
            @else
              @if($lang=='ko') 제보하신 내용에 대한 답변이 완료되었습니다. @else Your report has been answered. @endif
            @endif
          </td>
        </tr>
        <tr>
