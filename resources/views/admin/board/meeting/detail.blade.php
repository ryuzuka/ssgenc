{{-- 
  // 페이지명 : 이사회 진행사항 등록/수정
  // 설명 : 이사회 진행사항 상세 및 등록/수정을 한다.
--}}

{{-- 1) 보드 리스트형식의 템플릿 --}}
@extends('layouts.board_detail', [
      'title' => '게시판 관리',
      'subject' => '이사회 진행사항 등록/수정',
      'lang' => 'ko',
      'tab_no' => 1,
      'menu_no' => 0
  ])
...
@endphp
  ...
  <tr>
    <th scope="row">회차 <span>*</span></th>
    <td><input id="round" type="text" class="w760" placeholder="회차를 입력해 주세요." 
      @if(isset($item)) value="{{ $item->round }}" @endif>
    </td>
  </tr>
